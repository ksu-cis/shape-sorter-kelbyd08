...
namespace ShapeSorter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Shapes with area greather than 50");
            ...
            IEnumerable<Circle> filteredCirccles = circles.Where(circle => circle.Area < 70);

            Console.WriteLine("Shapes with area greather than 70");
